...
register(
    id='TrajectoryPlannerEnvironmentRaysRewardMPC-v0',
    entry_point='pkg_ddpg_td3.environment.variants.rays_reward_mpc:TrajectoryPlannerEnvironmentRaysRewardMPC',
    max_episode_steps=max_episode_steps,
)
