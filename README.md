...
Added decision mode 5 to main_continous.py and main_continous_evaluation.py where the reference trajectory is generated by multiple steps from the agent.
